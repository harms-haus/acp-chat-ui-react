...
# Generate all reports (text, json, html, lcov)
pnpm vitest run --coverage --reporter=text --reporter=json --reporter=html --reporter=lcov
...
grep -A5 "Uncovered" packages/acp-chat-core/coverage/index.html
```
...
coverage: {
  thresholds: {
    ...
    100: false, // Disable 100% strict mode
  },
...
- Unternary operators (`condition ? a : b`)
- Logical operators (`&&`, `||`)
